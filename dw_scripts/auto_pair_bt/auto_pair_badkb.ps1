...
for ($i = 0; $i -lt 10; $i++) {
    $cond = New-Object System.Windows.Automation.OrCondition(
        (New-Object System.Windows.Automation.PropertyCondition([System.Windows.Automation.AutomationElement]::NameProperty, "Impostazioni")),
...
while ($stopwatch.Elapsed.TotalSeconds -lt 90) {
    ...
    $addBtn = $settingsWin.FindFirst(
        ...
        (New-Object System.Windows.Automation.OrCondition(
            ...
            (New-Object System.Windows.Automation.PropertyCondition([System.Windows.Automation.AutomationElement]::NameProperty, "Add a device"))
        ))
    )
    if ($addBtn) {
